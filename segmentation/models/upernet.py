...
from segmentation.utils.helpers import initialize_weights
...
class UperNet(BaseModel):
    ...
    def __init__(self, num_classes, in_channels=3, backbone='resnet101', pretrained=True, use_aux=True, fpn_out=256, freeze_bn=False, resnet = None, **_):
